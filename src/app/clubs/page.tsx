...
export default function ClubsPage() {
  return (
    <CategoryPage
      heading={cat.heading}
      intro={cat.intro}
      body="EDM, 힙합, 하우스, 테크노. 장르가 곧 플로어의 정체성이다. 강남청담은 대형 사운드 시스템을 갖춘 곳이 밀집해 있고, 압구정은 트렌디한 감각이 돋보인다. 홍대·이태원은 글로벌 DJ가 자주 찾는 인디 씬의 거점이다. 드레스코드가 있는 곳이 대부분이라 슬리퍼·트레이닝복은 입장이 제한된다. 입장료와 음료비는 별도인 곳이 많다. 피크타임은 금·토 자정 전후. 일찍 도착하면 대기 없이 입장할 수 있다."
      guide={{
        title: '처음이세요?',
        items: [
