    ...
    <section className="section">
      <div className="container">
        ...
        <div className="narrow" style={{ marginBottom: '2.5rem' }}>
          <p style={{ color: '#111' }}>EDM, 힙합, 하우스, 테크노. 장르가 곧 플로어의 정체성이다. 각 지역마다 색이 다르다. 대형 사운드 시스템이 있는 곳, 소규모 공간에서 밀도 높은 경험을 주는 곳, 글로벌 DJ가 자주 찾는 곳까지 다양하다.</p>
          <p style={{ marginTop: '1rem', color: '#111' }}>드레스코드가 있는 곳이 대부분이다. 슬리퍼와 트레이닝복은 입장이 제한된다. 피크타임은 금·토 자정 전후. 일찍 도착하면 대기 없이 들어갈 수 있다. {year}년 기준 {venues.length}곳을 정리했다.</p>
        </div>
        ...
        <div className="narrow" style={{ marginTop: '2rem', padding: '2rem', background: '#F5F5F5', borderRadius: '16px', border: '1px solid #E5E7EB' }}>
          <h2 style={{ color: '#8B5CF6' }}>처음이세요?</h2>
